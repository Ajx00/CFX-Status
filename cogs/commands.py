...
class Commands(Cog):
    ...
    async def about(self, interaction: Interaction):
        ...
        embed.add_field(name='Support', value='[Click here](https://github.com/Ajx00/CFX-Status-BOT)',  inline=False)
        embed.add_field(
            name='Add Bot',
    ...
    async def features(self, interaction: Interaction):
       ...
       # embed.set_thumbnail(url="https://avatars.githubusercontent.com/u/122173112?v=4")
        embed.set_footer(
            text='Status Bot | by <@774679828594163802>',
            icon_url="https://avatars.githubusercontent.com/u/122173112?v=4"
        )
    ...
    async def help(self, interaction: Interaction):
        ...
        embed.set_thumbnail(url="https://avatars.githubusercontent.com/u/122173112?v=4")
        embed.set_footer(
            text='CFX Status bot | by <@774679828594163802>',
            icon_url="https://avatars.githubusercontent.com/u/122173112?v=4"
        )
